...
%
function BER_MC=ex4_1_MCQPSKrun(N,Eb,No,ChanAtt,...
...
SourceBitsI = SourceBitsI(1:TotalBits);
SourceBitsQ = SourceBitsQ(1:TotalBits);
SinkBitsI = SinkBitsI(1:TotalBits);
SinkBitsQ = SinkBitsQ(1:TotalBits);
%
