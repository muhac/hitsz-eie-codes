; ModuleID = 'C:/WORK/sobel_variable/axi_sobel/axi_sobel/sobel_rd_prj/solution1/.autopilot/db/a.g.1.bc'
...
ap_linebuffer.exit:                               ; preds = %entry
  ...
  %output_pixel.addr = getelementptr inbounds %"struct.ap_axiu<32,1,1,1>"* %output_pixel, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !2432 ; <i32*> [#uses=2]
...
bb16:                                             ; preds = %bb14
  ...
  %__Repl2__.3 = zext i16 %__Result__.4 to i32, !dbg !2851 ; <i32> [#uses=3]
  store i32 %__Repl2__.3, i32* %output_pixel.addr, align 8, !dbg !2432
