        ...
        for j = 1:sim_num
           ...
           for win_id = 1:length(window_select)
                ...
                [s_cont, t_cont, s, t, Sf, Sa, Fa] =...
                    Window(N, F, phi, SNR(k), 1, win, 0, 0); % 信号加窗
...
title('加不同窗时的 Rife 算法估计精度对比(偏移1/4个谱线间隔；瑞利噪声)','FontWeight','bold');
...
title('加不同窗时的 Jacobsen 算法估计精度对比(偏移1/4个谱线间隔；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
...
title('加不同窗时的 改进Quinn 算法估计精度对比(偏移1/4个谱线间隔；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
...
title('加不同窗时的 Rife 算法估计精度对比(无偏移；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
...
title('加不同窗时的 Jacobsen 算法估计精度对比(无偏移；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
...
title('加不同窗时的 改进Quinn 算法估计精度对比(无偏移；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
...
title('加不同窗时的 Rife 算法估计精度对比(偏移1/2个谱线间隔；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
...
title('加不同窗时的 Jacobsen 算法估计精度对比(偏移1/2个谱线间隔；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
...
title('加不同窗时的 改进Quinn 算法估计精度对比(偏移1/2个谱线间隔；瑞利噪声)','FontWeight','bold');
xlabel('SNR(dB)','FontWeight','bold');
ylabel('估计结果RMSE','FontWeight','bold');
legend('矩形窗','哈明窗','汉宁窗','布莱克曼窗');
grid on;
