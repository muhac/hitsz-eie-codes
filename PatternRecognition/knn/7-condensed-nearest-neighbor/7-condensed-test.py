...
class Log(object):
    def __init__(self, mode):
        # 记录日志并且打印在控制台
        logging.basicConfig(level=logging.INFO, filemode=mode, filename='7-condensed-test.txt', format='%(message)s')
...
if __name__ == '__main__':
    ...
    train_data, number_of_trains = samples_json('7-condensed.json')
