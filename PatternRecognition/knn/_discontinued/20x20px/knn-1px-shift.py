...
class Log(object):
    def __init__(self):
        logging.basicConfig(level=logging.INFO, filemode='w', filename='knn-1px-shift.txt', format='%(message)s')
...
def difference(x1, x2):
    ...
    diff_r = np.sum((x1[4:24, 4:24] - x2[4:24, 5:25]) ** 2)
    diff_d = np.sum((x1[4:24, 4:24] - x2[5:25, 4:24]) ** 2)
    diff_l = np.sum((x1[4:24, 4:24] - x2[4:24, 3:23]) ** 2)
    diff_u = np.sum((x1[4:24, 4:24] - x2[3:23, 4:24]) ** 2)
