...
class Log(object):
    def __init__(self):
        logging.basicConfig(level=logging.INFO, filemode='w', filename='knn-center-of-mass.txt', format='%(message)s')
...
def difference(x1, x2, r1, c1, r2, c2):
    s = np.sum((x1[r1 - 10:r1 + 10, c1 - 10:c1 + 10] - x2[r2 - 10:r2 + 10, c2 - 10:c2 + 10]) ** 2)
    return s
