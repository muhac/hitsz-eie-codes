...
parameters = {'alpha': (0.1,0.2,0.07,0.08,0.09,0.05),'degree':(1.5,1.7,1.9,2,2.1,2.3,2.5),'coef0':(0,0.2,0.6,1,2)}

grid_search = GridSearchCV(KRR, parameters, n_jobs=1, verbose=1)
