...
# df_train = pd.read_csv(r'd_train_fill_avg.csv', encoding='gbk')
...
print("Skewness: %f" % df_train['血糖'].skew())
print("Kurtosis: %f" % df_train['血糖'].kurt())
'''
Skewness: 5.551989
Kurtosis: 59.163792
'''
...
# standardizing data
saleprice_scaled = StandardScaler().fit_transform(df_train['血糖'][:, np.newaxis])
