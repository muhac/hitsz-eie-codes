...
print(msle(y_train_1,stacked_train_pred_1*0.7 + xgb_train_pred_1*0.15 + lgb_train_pred_1*0.15))
...
sub.to_csv(f"submission_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv", index=False)
