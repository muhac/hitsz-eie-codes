...
unsigned char character[3][26][2][8] = {
                                       {
                                        // A
                                        {{0b00011110,
                                          0b00100010,
...
int main(void)
{
    ...
    char* text = { "1920 Harbin Institute of Technology" };

    unsigned char led[3][8] = {character[2][25][1], character[2][25][1], character[2][25][1]};
    ...
    for (i = 0; k != -1; i++) {
        ...
        for (j = 0; j < 8; j++) {
            led[0][j] = led[1][j];
            led[1][j] = led[2][j];
            led[2][j] = character[m][n][1][j];
        }

        for (j = 0; j < 8; j++) {
            write(j + 1, led[0][j], j + 1, led[1][j]);
        }
        delay_ms(500);
    }
    ...
    while (1) {
        for (j = 0; j < 26; j++) {
            for (i = 0; i < 8; i++) {
                write(i+1, character[0][26 + j][1][i], i+1, character[0][52 + j][1][i]);
                // delay_ms(1000);
            }
            delay_ms(1000);
        }
