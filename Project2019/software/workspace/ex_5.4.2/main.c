...
void init(void)
{
    ...
    write(0x0F, 0x01, 0x0F, 0x01, 0x0F, 0x01, 0x0F, 0x01);       //显示测试：1；测试结束，正常显示：0
    delay_ms(1000);
...
void display(char* text) {
    ...
    for (i = 0; k != 99; i++) {
        ...
        for  (q = 0; q < 9; q++) {
            ...
            for (j = 0; j < 8; j++) {
                write(j + 1, character[88 + (i % 4)][1][j], j + 1, led[1][j], j + 1, led[2][j], j + 1,  character[92 + (i % 6)][1][j]);
            }
    ...
    for (i = 0; i < 32; i++) {
            ...
            led[3][7] = 0x00;
            for (j = 0; j < 8; j++) {
                write(j + 1, character[88 + (i % 20) / 5][1][j], j + 1, led[1][j], j + 1, led[2][j], j + 1, character[92 + (i % 30) / 5][1][j]);
            }
            delay_ms(50);
        }
}
